...
const ShareParser = (() => {
  ...
  // "के हक से/की/में" — the postposition varies (से/की/में) across real
  // documents but the meaning ("through/of the right of X") is the same;
  // matched broadly rather than only the "से" form seen in the first sample.
  const RE_DERIVATIVE = /के\s*हक(\s*(से|की|में))?|के\s*नाम|कुल\s*.*?हक\s*में|जरीये\s*(वसीयत|विक्रयपत्र|बैनामा)/;
